...
public final class ActivationRangeConfig {
    ...
    public static final ConfigEntry<Boolean> ANIMAL_TICK_INACTIVE = new ConfigEntry<>(true);
    ...
    public static final ConfigEntry<Boolean> NEUTRAL_TICK_INACTIVE = new ConfigEntry<>(true);
    ...
    public static final ConfigEntry<Boolean> WATER_TICK_INACTIVE = new ConfigEntry<>(true);
    ...
    public static final ConfigEntry<Boolean> MISC_TICK_INACTIVE = new ConfigEntry<>(true);
