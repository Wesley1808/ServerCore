...
public final class FeatureConfig {
    ...
    public static final ConfigEntry<Boolean> USE_DISTANCE_MAP = new ConfigEntry<>(false, " (Default = false) Optimizes vanilla's per-player mobspawning by using PaperMC's PlayerMobDistanceMap.");
    ...
    public static final ConfigEntry<Double> ITEM_MERGE_RADIUS = new ConfigEntry<>(0.5D, " (Default = 0.5) Decides the radius in blocks that items / xp will merge at.");
    public static final ConfigEntry<Double> XP_MERGE_RADIUS = new ConfigEntry<>(0.5D);
}
