...
public final class EntityConfig {
    ...
    public static final ConfigEntry<Integer> VILLAGER_RANGE = new ConfigEntry<>(64, "(Default = [Villager: 64, Animals: 64]) The range it will check for entities of the same type.");
